...
void slingshot_frontend_indicators_append (SlingshotFrontendIndicators* self, const gchar* thelabel) {
	...
	label = _tmp2_;
	memset (&white, 0, sizeof (GdkRGBA));
	gdk_rgba_parse (&white, "#FFFFFF");
	_tmp3_ = white;
	gtk_widget_override_color ((GtkWidget*) label, GTK_STATE_FLAG_NORMAL, &_tmp3_);
	...
	gtk_widget_override_font ((GtkWidget*) label, font);
	_tmp5_ = slingshot_frontend_utilities_wrap_alignment ((GtkWidget*) label, 5, 15, 5, 15);
	_tmp6_ = _tmp5_;
	gtk_container_add ((GtkContainer*) _data2_->indicator, (GtkWidget*) _tmp6_);
	_g_object_unref0 (_tmp6_);
	_tmp7_ = _g_object_ref0 ((GtkWidget*) _data2_->indicator);
